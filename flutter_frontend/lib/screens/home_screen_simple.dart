...
import 'eligibility_screen_simple.dart';
import 'profile_screen_simple.dart';
import 'alerts_screen_simple.dart';
              ...
              children: [
                _buildServiceCard(
                  ...
                  () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const EligibilityScreenSimple(),
                    ),
                  ),
                ),
                _buildServiceCard(
          ...
          switch (index) {
            ...
            case 2:
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const AlertsScreenSimple(),
                ),
              );
              break;
            case 3:
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const ProfileScreenSimple(),
                ),
              );
              break;
          }
